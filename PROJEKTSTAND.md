...
- **27.08. (PM-Budget Einzelsprünge + krumme Sieben, ~16:15)** — **beide Läufe abgeschlossen.** (1) **Grundrate der 534 Einzelsprünge: F=5, F?=3, U=526, X=0 — gegen einen Nullwert von 0,42 erwarteten Zufalls-Koinzidenzen (p95=2): die 8 sind belegt, kein Zufall.** Gedreht gelesen: 98,5 % der Sprünge haben positiv belegt KEINEN Split — die Rückanpassung des Tagesarchivs funktioniert fast immer; sie versagt in 5 belegten Fällen: WHLR 26.08.2026 + 03.04.2017 (bekannt), **NEU: IESC 24.08.2026 (der Split von vor drei Tagen ungeglättet), WY 20.07.2010 (Aktien-Sonderausschüttung), EXPE 21.12.2011 (mit Vorbehalt: Kombi Split+TripAdvisor-Spin-off)**. F? (SMCX/UCO/WEN) ist die „etwas stimmt nicht"-Liste, UCO zeigt: sie fängt auch echte Crashs an Split-Tagen. (2) **Krumme Sieben: CBSH BESTÄTIGT** (Massive führt die jährlichen 5-%-Aktiendividenden als 1:1,05-Splits, exakt am vorhergesagten 01.12.2023 — Nebenertrag: Aktiendividenden stehen im Splits-Datensatz), **DOC nach B-Standard BELEGT als Trennfall** (ticker_change 04.03.2024 exakt am Quoten-Sprungtag + Dividendenbruch 0,23→0,30 + Drift — zwei Firmen unter einem Kürzel, teilen statt reparieren), **GBTC/ETHE wie registriert unentscheidbar** mit benannter EDGAR-prüfbarer Hypothese (Grayscale-Mini-Trust-Abspaltungen Juli 2024). Netzausfall ~90 min während des Laufs, zweiter Durchgang schloss alle Lücken (0 Fehler, 275/275). Details `studien/analytiker/2026-08-27/BEFUND-EINZELSPRUENGE.md`.
