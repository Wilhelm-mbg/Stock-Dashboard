...
- Aktueller Stand: **v8.40.0** (04.09.2026, Stufe 5).
...
- Klick-Sperrliste für UI-Tests: nie `#kostenRundeBtn`, `#mfdRebalanceBtn`, `#mfdDriftBtn`, `#mfdTaktBtn`, `#massenBtn`, `#massen1mBtn`, `#runJobBtn`, `#btRunBtn`, `#drLadeBtn`, `#drLadeAlleBtn`, kein „Jetzt holen"; nie die laufende App oder ihren Store anfassen; nur isolierte Instanzen (`tools/ui-probe.js`, `tools/ui-aufnahmen.js --kunstdaten`).
