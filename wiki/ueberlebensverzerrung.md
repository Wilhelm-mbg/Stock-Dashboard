...
## Gemessen 08.09.2026: die Lücke ist zu (Signalstudie Minuten, 5m/15m)

Erstmals eine Signalmessung über ein Archiv **mit** den Verschwundenen (4.993 von 7.299 Aktien, 2016–2026, Alpaca 1m). Die Studie rechnet jede Konfiguration zweimal, „alle" und „nur lebend", und weist die Differenz je Familie aus (`studien/vorregistrierung-2026-09-06-signale-minuten/ergebnis-5m15m-2026-09-08/ERGEBNIS.md` §4): **Dip −0,002 … −0,009 Pp**, Ausbruch +0,001 … +0,004, Wende −0,000 … +0,009 — gegen **−3,78 Pp** im August auf Yahoo-Tagesdaten. Zwei Lesarten, beide belegt: (1) auf Minutenbasis mit Haltedauern von Stunden ist der Überlebenseffekt klein, weil der Verlust der Verschwundenen nicht in einem Handelstag passiert; (2) das Archiv, das die Verschwundenen führt, ist da — die Frage „≥ 12,7 % des Querschnitts fehlen" ist für diesen Datensatz beantwortet. Für Übernacht- und Tagesstudien bleibt die alte Warnung, bis sie auf demselben Archiv wiederholt sind.
