...
| **4 Archiv-Grafik, Kopfzeile, Werkzeug-Politur** | eine Grafik „wie vollständig ist das Archiv" statt Tabelle; Kopfzeile wieder einzeilig (Simulations-Satz als Marke „Simulation" mit i-Knopf, Satz wörtlich im Register — Abweichung 5 der Stufe-3-Übergabe); Restwände in der Intraday-Karte (Marktlage-Absatz); Explorer/Schein-Finder auf Wilhelms Zuruf | **beauftragt 03.09.** |
