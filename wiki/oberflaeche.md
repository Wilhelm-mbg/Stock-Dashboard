...
| **8a Viewer — Reparatur und Grundbedienung** | Zeitraum × Kerze, Maus-Zoom, MA über die ganze Reihe, Signale/Kanäle/Indikatoren im Kerzenchart, Fadenkreuz-Statuszeile | 🔵 **beauftragt 05.09.** (`uebergabe/auftrag-viewer-8a-2026-09-05.md`) |
| **8b Viewer — Chart-Einstellungen** | Dialog mit Reitern Symbol · Statuszeile · Skala und Linien · Ereignisse · Vorlagen, reines Modul `markt/charteinstellungen.js` | 🔵 **beauftragt 05.09.** (`…8b…`) |
