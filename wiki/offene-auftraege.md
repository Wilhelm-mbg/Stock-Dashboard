...
| Auftrag | Zustand |
|---|---|
| **Momentum-Buch auf liquiden Korb** | **Beauftragt 02.09.** Buch = gemessene Konfiguration aus `studien/vorregistrierung-2026-09-02-momentum-liquide/`, Sperrklinke, Umstellung im Journal protokolliert. Reine Simulation, kein echtes Geld |
