...
| **Oberfläche Stufe 1 — Umzug auf drei Bildschirme** | **Beauftragt 02.09. (spät).** 5 → 3 Reiter (Heute · Regeln · Werkzeuge), neue Pille Werkzeuge → Betrieb als Maschinenraum (Klappen mit Statuszeile), Bestand/Papiere/Protokoll nach Heute, Messung nach Betrieb; keine Textänderung, keine Löschung; 26 Sperrklinken an der Navigation ziehen mit (Liste in [oberflaeche.md](oberflaeche.md) §5); ui-probe/a11y-probe vorher und nachher, Aufnahmen aller Seiten; `tools/ui-aufnahmen.js` anlegen. Danach Stufe 2 (Bestand & Kopfzeile), 3 (Schnitt), 4 (Archiv-Grafik). |
